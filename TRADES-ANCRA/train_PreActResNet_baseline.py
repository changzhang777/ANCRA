...
parser.add_argument('--model-dir', default='/model/TRADES-PreAct',
...
def main():
    ...
    trainset = TinyImageNet('/dataset/tiny-imagenet-200', train=True, transform=transform_train)
    ...
    model = preactresnet.PreActResNet18(num_classes=class_number).cuda()
